...
public partial class CompoundBuilder {
    ...
    public void Add(String Name, Byte Value) {
        this.Add(NBTTagFactory.Create(NBTTagType.Byte, Name, Value));
    }
    ...
    public void Add(String Name, Boolean Value) {
        this.Add(NBTTagFactory.Create(NBTTagType.Byte, Name, (Byte)(Value ? 1 : 0)));
    }
    ...
    /// <param name="Value">The value of the tag to add to the collection</param>
    public void Add(String Name, Byte[] Value) {
        this.Add(NBTTagFactory.Create(NBTTagType.ByteArray, Name, Value));
    }
    ...
    public void Add(String Name, Double Value) {
        this.Add(NBTTagFactory.Create(NBTTagType.Double, Name, Value));
    }
    ...
    public void Add(String Name, Single Value) {
        this.Add(NBTTagFactory.Create(NBTTagType.Float, Name, Value));
    }
    ...
    public void Add(String Name, Int32 Value) {
        this.Add(NBTTagFactory.Create(NBTTagType.Int, Name, Value));
    }
    ...
    /// <param name="Value">The value of the tag to add to the collection</param>
    public void Add(String Name, Int32[] Value) {
        this.Add(NBTTagFactory.Create(NBTTagType.IntArray, Name, Value));
    }
    ...
    public void Add(String Name, Int64 Value) {
        this.Add(NBTTagFactory.Create(NBTTagType.Long, Name, Value));
    }
    ...
    /// <param name="Value">The value of the tag to add to the collection</param>
    public void Add(String Name, Int64[] Value) {
        this.Add(NBTTagFactory.Create(NBTTagType.LongArray, Name, Value));
    }
    ...
    public void Add(String Name, Int16 Value) {
        this.Add(NBTTagFactory.Create(NBTTagType.Short, Name, Value));
    }
    ...
    public void Add(String Name, String Value) {
        this.Add(NBTTagFactory.Create(NBTTagType.String, Name, Value));
    }
    #endregion
    ...
    public void Add(String Name, List<Byte> Value) {
        this.Add(NBTTagFactory.Create(Name, Value));
    }
